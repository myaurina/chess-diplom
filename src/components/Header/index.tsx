    ...
    <header className={style.header}>
      <div className={`${style.headerInner} container`}>
        <div className={style.headerLeft}>
          <button className={style.headerButtonBurger} onClick={onClickButtonBurger}>
            <div
          ...
          <Link to="/" className={style.headerLogoWrapper} onClick={() => setIsActiveMenu(false)}>
            <img src={Logo} alt="Шахматы ИвГУ" className={style.headerLogo} />
            <span className="text-level-3">
              Шахматы <span className={style.headerLogoUnivercityName}>ИвГУ</span>
            </span>
          </Link>
        </div>
          ...
          <nav className={style.headerNav}>
            <ul className={style.headerNavList}>
              {headerNavLinks.map((headerNavLink) => (
                <li className={style.headerNavListItem} key={headerNavLink.text}>
                  <Link
                    to={headerNavLink.to}
        ...
        <Link to="/login" className={style.headerLogin} onClick={() => setIsActiveMenu(false)}>
